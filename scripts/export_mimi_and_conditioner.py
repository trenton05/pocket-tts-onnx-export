...
def export_models(output_dir="onnx_models", weights_path="weights/model.safetensors"):
    ...
    onnx.save(float16.convert_float_to_float16(onnx.load(encoder_onnx_path)), os.path.join(output_dir, "mimi_encoder_fp16.onnx"))
    ...
    onnx.save(float16.convert_float_to_float16(onnx.load(mimi_onnx_path)), os.path.join(output_dir, "mimi_decoder_fp16.onnx"))
